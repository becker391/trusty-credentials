...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <StatsGrid>
        <StatsCard label="Total Credentials" value={stats.totalCredentials} icon={BarChart3} trend="+12%" />
        <StatsCard label="Monthly Growth" value="18%" icon={TrendingUp} trend="+3%" />
        <StatsCard label="Active Students" value={stats.totalStudents} icon={Users} trend="+8%" />
        <StatsCard label="Avg Verification Time" value={`${stats.avgVerificationTime}s`} icon={Shield} />
      </StatsGrid>

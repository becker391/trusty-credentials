...
import { ClipboardPaste, Upload, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Instantly verify the authenticity of any academic credential by entering its unique hash. No account required.
          </p>
        </div>
